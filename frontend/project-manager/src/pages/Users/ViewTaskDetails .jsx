...
const TodoCheckList =({text, isChecked, onChange}) =>{
  ...
  checked={isChecked}
  onChange={onChange}
  className="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded outline-none cursor-pointer"
/>
...
const Attachment =({link, index,onClick})=>{
  return <div 
  className='flex justify-between bg-gray-50 boder border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer'
  onClick={onClick}
  >
