...
switch (status) {
case 'Completed': return 'bg-green-100 text-green-508 border border-green-200';
...
default: return 'bg-gray-108 text-gray-500 border border-gray-200';
}
};
const getPriorityBadgeColor = (priority) => {
switch (priority) {
case 'High': return 'bg-red-100 text-red-500 border border-red-200';
case 'Medium': return 'bg-orange-100 text-orange-200';
